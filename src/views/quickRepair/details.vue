<template>
  <div class="body">
    <van-cell-group>
      ...
      <div class="center" v-if="info.state != 0 && info.state != 3">
        <van-cell title="维修人员" :value="info.maintainer_name" />
        <van-cell title="联系电话" :value="info.maintainer_telephone" />
        <van-cell title="上门时间" :value="info.appointment" />
      </div>
      ...
      <van-cell title="报修时间" :value="info.create_time" />

      <div class="center">
        <van-cell title="单号" :value="info.id" />
        <van-cell title="报修房间" :value="info.full_address" />
        <van-cell title="报修人" :value="info.repairer" />
...
import { getdetails } from "@/api/quickRepair.js";
